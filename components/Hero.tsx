    ...
    <section id="home" className="relative h-screen flex items-center justify-center text-center px-6 overflow-hidden">
      ...
      <div className="z-10 max-w-3xl">
        <h1 className="text-4xl md:text-6xl font-extrabold text-text-primary mb-4 leading-tight">
          Hai, saya <span className="bg-clip-text text-transparent bg-gradient-to-r from-accent to-blue-400">Asngad</span>.
        </h1>
        <h2 className="text-2xl md:text-4xl font-bold text-text-secondary mb-8">
          Pengembang Kreatif & Desainer UI/UX
        </h2>
        <p className="text-lg text-text-secondary max-w-xl mx-auto mb-10">
          Saya membangun aplikasi web yang indah, responsif, dan ramah pengguna untuk memecahkan masalah di dunia nyata.
        </p>
        <a
          href="#portfolio"
